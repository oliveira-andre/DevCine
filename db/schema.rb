...
ActiveRecord::Schema[8.0].define(version: 2026_09_07_231216) do
  ...
  create_table "audio_tracks", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["video_id", "position"], name: "index_audio_tracks_on_video_id_and_position"
  end
